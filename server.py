...
def build_assistant_system_prompt(user_row, profile, language="sk"):
    ...
    if language == "en":
        return (
            ...
            "If the user asks about unrelated topics, do not develop that topic. Briefly state that Unifyo AI is focused on financial intermediation and related work topics, then redirect to a relevant work question such as: How can I help with your clients, tasks or financial communication today? "
    ...
    return (
        ...
        "Ak sa používateľ spýta na inú tému, túto tému ďalej nerozvíjaj. Stručne povedz, že Unifyo AI je zameraná na finančné sprostredkovanie a súvisiacu prácu, a potom používateľa presmeruj na relevantnú otázku typu: Ako ti viem dnes pomôcť s klientmi, úlohami alebo finančnou komunikáciou? "
