...
def build_assistant_system_prompt(user_row, profile):
    ...
    return (
        ...
        "Používaj štruktúru odpovede: 1) Krátke zhrnutie 2) Dôležité body 3) Odporúčané ďalšie kroky 4) Relevantné zdroje. "
        "Keď súvisí téma s reguláciou, dohľadom alebo finančným trhom, preferuj oficiálne zdroje a uveď odkazy. "
        "Prioritné zdroje, ktoré môžeš odporučiť podľa kontextu: https://alanrampacek.sk, https://prosight.sk, https://nbs.sk "
        "a oficiálne stránky finančných inštitúcií. "
        "Nevymýšľaj si fakty. Ak si niečím neistý, jasne to povedz a navrhni overenie v oficiálnom zdroji. "
